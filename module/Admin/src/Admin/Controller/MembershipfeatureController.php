...
use Admin\Form\MembershipfeatureFilter;
use Admin\Form\MembershipfeatureForm;
...
class MembershipfeatureController extends AppController {

    protected $data = '';
    protected $commonService;
    protected $adminService;
    protected $membershipfeatureService;

    public function __construct(CommonServiceInterface $commonService, AdminServiceInterface $adminService, MembershipfeatureServiceInterface $membershipfeatureService) {

        $this->commonService = $commonService;
        $this->adminService = $adminService;
        $this->membershipfeatureService = $membershipfeatureService;
    }

    public function indexAction() {
        //echo  "hello";exit;
//        $tests = $this->membershipfeatureService->test();
//        print_r($tests);exit;
//        $newses = $this->getNewsTable()->fetchAll();
        
        $membershipfeatures = $this->membershipfeatureService->getMembershipfeatureList()->toArray();
        
        //\Zend\Debug\Debug::dump($membershipfeatures);exit;
...
//                print_r($Info);exit;
    ...
    public function changestatusAction() {
        ...
        $result= $this->adminService->changeStatus('tbl_membership_features', $request->getPost('id'), $request->getPost());
        // print_r($return);
...
//        print_r($data);die;
    ...
    public function categorychangestatusAction() {
        ...
        $request=$this->getRequest();
        //$return = $this->getReligionTable()->updatestatus($data);
        $result= $this->adminService->changeStatus('tbl_newscategory', $request->getPost('id'), $request->getPost());
        // print_r($return);
        return new JsonModel($result);
        //exit();
    }
