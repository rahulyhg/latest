...
class ObituaryController extends AbstractActionController {
    ...
    public function indexAction() {
        ...
        $sql = "select tp.*,tui.full_name from tbl_post as tp inner join tbl_user_info as tui on tp.user_id=tui.user_id "
                . "WHERE tp.post_category='2' and tp.is_active=1 ORDER BY id DESC";
    ...
    public function ViewAction() {
        ...
        // Query to Count Total Likes and View Counts for the post ///
        ...
        LEFT JOIN tbl_user_gallery as tug on tbl_posts_comments.user_id=tug.user_id
        where tbl_posts_comments.is_active=1 and tug.profile_pic=1 and tbl_posts_comments.post_id='$id' order by tbl_posts_comments.id DESC";
...
//---Unlike----
    ...
    public function postfiltersAction() {
        ...
        $catfield = "and tbl_post.post_category=2";
