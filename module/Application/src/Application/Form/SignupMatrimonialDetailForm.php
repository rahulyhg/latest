...
class SignupMatrimonialDetailForm extends Form {
    ...
    public static $religionList=array();
    ...
    public function __construct(CommonServiceInterface $commonService) {
       ...
       // $this->setObject(new SignUpFormEntity());
        ...
        $this->add(array(
            ...
            'attributes' => array(
                'type' => 'text',
                'onkeyup' => 'checkMatrimonialduplicate($(this).val(),this.id,"' . self::$checkAlreadyExist . '",checkMatrimonialDuplicateResults);',
                'class' => 'form-control1',
                'id' => 'native_place'
            ),
            'options' => array(
