...
class PersonolDetailForm extends Form {
    ...
    public static $communityList = array();
    ...
    public function __construct(CommonServiceInterface $commonService, $religionId=null,$communityId=null,$casteId=null) {
       ...
       // var_dump($this->commonService->getReligionList(),$this->commonService->getCommunityListByRelgionId($religionId)); exit;
       // $this->commonService->getCommunityListByRelgionId($religionId));
        
       //var_dump($this->commonService->getReligionList(), $this->commonService->getCommunityNamesListByRelgionId($religionId)); exit;
        self::$gothraNameList=$this->commonService->getGothraNameListByCastId($casteId);
        self::$religionNameList=$this->commonService->getReligionList();
        self::$communityList=$this->commonService->getCommunityNamesListByRelgionId($religionId);
        ...
        self::$casteNameList=$this->commonService->getCasteNameListByCommunityId($communityId);
        ...
        $this->add(array(
            ...
            'options' => array(
                ...
                'value_options' =>  self::$communityList,
